...
//        MyChannelHandlerPool.channelGroup.find(afe);
    }
...
//        MyChannelHandlerPool.channelGroup

        MyChannelHandlerPool.channelGroup.find(fromId).writeAndFlush(new TextWebSocketFrame(map.get("msg").toString()));
//                new TextWebSocketFrame(map.toString()));

        ChannelId toId = MyChannelHandlerPool.channelIdMap.get(map.get("toId"));
        MyChannelHandlerPool.channelGroup.find(toId).writeAndFlush(new TextWebSocketFrame(map.get("msg").toString()));
//                new TextWebSocketFrame(map.toString()));
    }
